...
import { Mail, ExternalLink, ChevronLeft, ChevronRight, X, Filter, Sparkles, Heart, Eye } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
      ...
      <header className="fixed top-0 w-full z-50 premium-glassmorphism border-b border-white/20">
        <nav className="container mx-auto px-6 py-5">
          <div className="flex items-center justify-between">
            ...
            <Button size="sm" className="premium-button group overflow-hidden relative">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className={`max-w-5xl mx-auto ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
            ...
            <h2 className="hero-title text-6xl lg:text-8xl font-bold mb-8 leading-tight">
              <span className="block text-slate-800">{mockDesigner.tagline.split(' ')[0]}</span>
              <span className="block bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
                {mockDesigner.tagline.split(' ').slice(1).join(' ')}
              </span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              <Button variant="outline" size="lg" className="premium-outline-button">
      ...
      <section className="py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;utf8,<svg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"><g fill=\"none\" fill-rule=\"evenodd\"><g fill=\"%23ffffff\" fill-opacity=\"0.05\"><circle cx=\"30\" cy=\"30\" r=\"2\"/></g></g></svg>')]"></div>
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <Button size="lg" className="premium-contact-button group">
              <Mail className="w-6 h-6 mr-3 group-hover:scale-110 transition-transform" />
              <span className="text-lg font-medium">{mockDesigner.email}</span>
            </Button>
          </div>
        </div>
      </section>
